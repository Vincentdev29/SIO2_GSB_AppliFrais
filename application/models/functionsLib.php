...
class FunctionsLib extends CI_Model {
  ...
  /**
  * Indique si une valeur est un réel positif ou non
  * Le réel commence par une valeur positive
  * et ne contient pas de caractère non numérique

  *@param $valeur
  *@return vrai ou faux
  */
  public function estReelPositif($valeur)
  {
    return preg_match("/[^0-9]/", $valeur) == 0;
  }
  ...
  function afficheMessageErreur($titre, $message){
    //return ;
  }
